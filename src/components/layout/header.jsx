  ...
  <Link href="/cart" onClick={closeMobileMenu}>
    <div className="relative flex items-center">
      ...
      <Link href="/cart" onClick={closeMobileMenu}>
                  <ShoppingCart />
                  {getTotalItems() > 0 && (
                    <span className="m-1 absolute-top-2-right-2 bg-red-600 text-white
                     text-sm w-5 h-5 rounded-full flex flex-row items-center justify-center">
                      {getTotalItems()}
                    </span>
                  )}
                </Link>
...
// "use client";             // i added implement search to correspond with product filter on the code above
