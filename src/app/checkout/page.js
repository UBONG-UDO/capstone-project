...
//               {/* Inputs omitted for brevity — unchanged from your code */}
//               {/* Use your existing input elements and error display */}
//             </div>
//           </div>
...
"use client";  // Load from top code above
...
export default function CheckoutPage() {
  ...
  if (cartItems.length === 0) {
    return (
      <main className="p-8 max-w-3xl mx-auto text-center pt-[120px]">
        <h1 className="text-3xl font-bold mb-6">Checkout</h1>
        <Image
          src="/images/emptyCart.png"
          alt="Empty Cart"
